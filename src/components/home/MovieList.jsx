    ...
    <>
      <section className="container mt-4 bg-slate-50 p-y-4 shadow-lg">
        <div className="flex justify-between border-b-4  font-semibold text-white ">
          <div className="w-fit px-8 py-2 capitalize rounded-t-lg bg-emerald-600">
            {categoryName}
          </div>
        </div>
        ...
        <button
          className="bg-emerald-600 text-white w-full text-end py-1 px-2 rounded-lg flex gap-2 content-center capitalize"
          onClick={() => navigate("/popular")}
        >
          Show more {categoryName} movies
        </button>
      </section>
    </>
  );
